...
function Home() {
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center text-gray-800 overflow-hidden">
      ...
      <section className="relative bg-gradient-to-r from-blue-700 to-indigo-900 text-white h-[60vh] flex flex-col items-center justify-center">
  <h1 className="text-5xl font-bold">RescueRadar</h1>
  <p className="mt-4 text-lg text-gray-200">Stay ahead of disasters. Be prepared. Stay safe.</p>
  <button className="mt-6 px-6 py-3 bg-red-600 hover:bg-red-700 rounded-xl shadow-lg transition">
    Get Started
  </button>
